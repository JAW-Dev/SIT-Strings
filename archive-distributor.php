...
/**
 * Distributor Archive
 * Output distributors by country taxonomy
*/
get_header() ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <span class="breadcrumbs breadcrumbs--short"><?php if (function_exists('rank_math_the_breadcrumbs')) rank_math_the_breadcrumbs(); ?></span>
      </div>
    </div>
  </div>
      ...
      <div class="row justify-content-center">
        <div class="wave-wrapped-section__col col-sm-auto">
          <div class="wave-wrapped-section__content py-6">
            <h1 class="has-text-align-center is-style-outline">International Dealers and Distributors</h1>
          </div>
  ...
  <div class="container">
    <?php if (have_posts()): ?>
      <div class="dealer-search">
        <div class="row dealer-search__row my-sm">
          <?php
                ...
                if ($loop->have_posts()):
                  ...
                  ?>
                    <div class="dealer">
                      ...
                      <?php if (!empty($email)): ?>
                        <a target="_blank" class="dealer__email-link"
                          href="mailto:<?= $email ?>"><svg viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.00001 0C0.734792 0 0.480438 0.105357 0.292902 0.292893C0.105365 0.48043 8.58307e-06 0.734784 8.58307e-06 1V1.99551C-2.91055e-06 1.99829 -2.90919e-06 2.00106 8.58307e-06 2.00384V17C8.58307e-06 17.5523 0.447724 18 1.00001 18L21 18C21.2652 18 21.5196 17.8946 21.7071 17.7071C21.8947 17.5196 22 17.2652 22 17V2.00402C22 2.00112 22 1.99823 22 1.99533V1C22 0.447716 21.5523 0 21 0H1.00001ZM19.5052 2L2.49486 2L11 9.65464L19.5052 2ZM2.00001 4.24536V16L20 16V4.24536L11.669 11.7433C11.2887 12.0856 10.7113 12.0856 10.331 11.7433L2.00001 4.24536Z" fill="#BF1E2E"/></svg>Email</a>
                      <?php endif; ?>
